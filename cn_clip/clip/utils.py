...
def tokenize(texts: Union[str, List[str]], keyword: Union[str, List[str]],context_length: int = 52) -> torch.LongTensor:
    """
    ...
    return result[0]#, sent_results[0]
